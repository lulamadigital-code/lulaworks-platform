...
_COUNTRY_DOCUMENTS = {
    ...
    "GH": ["Certificate of Incorporation", "TIN certificate",
           "VAT registration", "Bank confirmation"],
    "EG": ["Commercial Registration extract", "Tax Card",
           "VAT registration", "Bank confirmation"],
    "MA": ["Registre de Commerce (RC)", "Certificat ICE",
           "Attestation fiscale", "Bank confirmation"],
    "TZ": ["Certificate of Incorporation (BRELA)", "TIN certificate",
           "VAT registration", "Bank confirmation"],
    "UG": ["Certificate of Incorporation (URSB)", "TIN certificate",
           "Trading licence", "Bank confirmation"],
    "RW": ["Certificate of Incorporation (RDB)", "TIN certificate",
           "Bank confirmation"],
    "ET": ["Business/Trade Licence", "TIN certificate", "VAT registration",
           "Bank confirmation"],
}
