...
urlpatterns = [
    ...
    path("platform/analytics/export/<str:kind>.csv", views_platform.platform_analytics_export, name="platform_analytics_export"),
    ...
    path("support/<uuid:pk>/messages/", views_support.support_messages, name="support_messages"),
    ...
    path("platform/search/", views_platform.platform_search, name="platform_search"),
    ...
    path("platform/support/<uuid:pk>/messages/", views_platform.platform_support_messages, name="platform_support_messages"),
    path("platform/support/<uuid:pk>/send/", views_platform.platform_support_send, name="platform_support_send"),
    ...
    # Marketing (Phase 1) — campaigns, segments, lead sources, over the CRM.
    path("marketing/", views_marketing.marketing_home, name="marketing"),
    path("marketing/campaigns/", views_marketing.campaigns_list, name="marketing_campaigns"),
    path("marketing/campaigns/new/", views_marketing.campaign_new, name="marketing_campaign_new"),
    path("marketing/campaigns/<uuid:pk>/", views_marketing.campaign_detail, name="marketing_campaign_detail"),
    path("marketing/segments/", views_marketing.segments_list, name="marketing_segments"),
    path("marketing/segments/new/", views_marketing.segment_new, name="marketing_segment_new"),
    ...
    path("company/templates/import/<uuid:pk>/regenerate/",
         views_doctemplates.template_import_regenerate,
         name="doc_template_import_regenerate"),
    ...
    path("company/templates/<uuid:pk>/apply-set/",
         views_doctemplates.template_apply_default_set,
         name="doc_template_apply_set"),
