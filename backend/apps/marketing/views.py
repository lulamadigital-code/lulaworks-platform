...
_MODULES = [
    ("🏢", _("Company Management"), _("Your business identity, entered once and reused everywhere."),
     [_("Company profile, VAT & registration numbers, banking and branding"),
      _("Flows onto every quotation, invoice and delivery note automatically")]),
    ("🤝", _("Customer Management"), _("Every client organisation, department and contact in one place."),
     [_("Contacts, sites and a full communication timeline"),
      _("Documents routed to the right person by responsibility")]),
    ("📝", _("Quotation Management"), _("Build accurate, professional quotes in minutes."),
     [_("Per-type templates and spreadsheet-style bulk line entry"),
      _("Branded PDF output; award a quote to open a job in one click")]),
    ("🔧", _("Jobs"), _("The operational heart — every job in a single view."),
     [_("Scope, team, progress, money and paperwork together"),
      _("Raised from a quotation, a customer PO, or started standalone")]),
    ("📂", _("Projects"), _("Group related jobs under one engagement."),
     [_("Roll up commercial documents, budget, actuals and timeline"),
      _("Readiness gate keeps compliance in check before work starts")]),
    ("✅", _("Tasks"), _("Break work down and track it to completion."),
     [_("Checklists, owners, dependencies and live progress"),
      _("Field reports, GPS and evidence captured against each task")]),
    ("🛒", _("Procurement"), _("Buy the right materials at the right price."),
     [_("Raise procurement requests and compare supplier prices"),
      _("Issue purchase orders and reconcile against receipts")]),
    ("🏭", _("Suppliers"), _("A supplier database that builds itself."),
     [_("Every receipt records who you bought from and what you paid"),
      _("Manual entry and old-invoice upload to seed your history")]),
    ("📦", _("Products"), _("Know the real price of everything you buy."),
     [_("Price comparison across suppliers, trends and stale-price flags"),
      _("Product aliases so the same item is never counted twice")]),
    ("🧾", _("Purchase Orders"), _("Turn approved buying into clean paperwork."),
     [_("Generate and track POs against jobs and suppliers"),
      _("Extract incoming customer POs with AI")]),
    ("💰", _("Invoices"), _("Get paid, and see it clearly."),
     [_("Compliant tax invoices and progress claims with retention"),
      _("Payments and outstanding balances tracked per job")]),
    ("🚚", _("Delivery Notes"), _("Prove delivery, on brand."),
     [_("Generate delivery notes straight from the job"),
      _("Quantities and signatures captured for the record")]),
    ("📊", _("Reports & Analytics"), _("Run the business on numbers, not guesswork."),
     [_("Profitability, cash flow, aging and job health"),
      _("Field spend flows into live profitability automatically")]),
    ("📱", _("Employee App"), _("The field team's tool, built mobile-first."),
     [_("Capture time, materials, fuel and progress from site"),
      _("Works for technicians, drivers, welders, operators and labourers")]),
    ("📍", _("GPS Tracking"), _("Know who was on site, and when."),
     [_("Every field check-in is GPS-stamped and time-stamped"),
      _("Distance-from-site flags keep records honest")]),
    ("🤖", _("AI Automation"), _("Let AI do the data entry."),
     [_("Extract RFQs, purchase orders, supplier invoices and scopes of work"),
      _("AI quotation suggestions grounded in your own history")]),
    ("🔒", _("Security"), _("Enterprise-grade protection for your data."),
     [_("Role-based access control and full audit logging"),
      _("Tenant isolation so your data is only ever yours")]),
    ("☁️", _("Cloud Platform"), _("Always on, everywhere."),
     [_("Access from desktop, tablet and mobile"),
      _("Automatic backups and no software to install")]),
]
