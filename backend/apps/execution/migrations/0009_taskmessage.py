# Generated by Django 6.0.2 on 2026-08-24 16:52
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('execution', '0008_attendanceevent'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('text', 'Message'), ('system', 'System event'), ('image', 'Photo')], default='text', max_length=8)),
                ('body', models.TextField(blank=True)),
                ('image', models.FileField(blank=True, null=True, upload_to='chat/%Y/%m/')),
                ...
                ('task', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='execution.task')),
            ...
            options={
                'ordering': ['created_at'],
                'indexes': [models.Index(fields=['company', 'task', 'created_at'], name='execution_t_company_837f78_idx')],
            },
        ),
    ]
